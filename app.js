      ...
      rows.push(`<tr class="package-header-row" onclick="event.stopPropagation()">
        <td colspan="7">
          <div class="package-header">
            ...
            <button class="btn btn-secondary btn-xs" onclick="event.stopPropagation();downloadPackageInvoice('${escapeHtml(pkgId)}')" title="Download Package Invoice" style="margin-left:auto;">Invoice</button>
