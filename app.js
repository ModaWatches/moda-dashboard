...
function renderDealsAlert(data) {
  ...
  list.innerHTML = deals.map(d => {
    ...
    return `<div class="deals-alert-item" style="cursor:pointer;" onclick="switchView('deals')">
      <span class="deals-alert-item-info"><strong>${d.reference_code}</strong> · ${d.seller_name || 'Unknown'} · ${watch}</span>
...
async function openDealDetail(dealId) {
  try {
    ...
    document.getElementById('dealDetailTitle').textContent = `Deal ${d.reference_code}`;
